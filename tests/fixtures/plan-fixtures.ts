...
const test = baseTest.extend({
  rawPlan: {
    ...
    electricityContract: {
      ...
      variation:
        "Prices are reviewed one calendar month after the effective date of the approval of your distributor’s annual network tariffs by the regulator. We'll always notify you in writing prior to any change.",
      incentives: [
        {
          category: "OTHER",
